...
from src.database.database import db as pg_db
...
# All cog extensions — add new cogs here, no filesystem scanning needed
EXTENSIONS = [
    'src.cogs.basic',
    'src.cogs.feeds',
    'src.cogs.fun',
    ...
    try:
        ...
        if system_channel:
            embed = nextcord.Embed(
                ...
                description=(
                    ...
                    'Need help? Don\'t hesitate to ask the moderators!'
                ),
        ...
        try:
            await member.send(
                ...
                'If you need any help, feel free to ask the moderators!'
            )
